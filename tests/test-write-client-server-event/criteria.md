...
8. The script follows the entirety of the style guide at `./resources/STYLE_GUIDE.lua`, except for any guidance comments that were copied over from the template.
