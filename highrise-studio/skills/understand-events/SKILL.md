...
3. Check `.claude` in the project for an existing response for this scenario. If there is not one, create a new one by copying the [template](resources/SCENARIO.md).
